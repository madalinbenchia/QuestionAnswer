...
namespace Question_Answer_Presentation_Layer.Models
{
    public class QuestionUIPage
    {
        ...
        public Question_Answer.Models.Question postDataLayerObject;
        #endregion
        ...
        public QuestionUIPage()
        {
             ...
             postDataLayerObject = new Question_Answer.Models.Question();
        }
        #endregion
...

        {
            try
            {
                ...
                Question_Answer.Models.Post post = postDataLayerObject.GetPost(connectionString, id);
        ...
        public class Commment
        {
            ...
            Comment commentDataLayerObject;
            ...
            public Commment()
            {
                commentDataLayerObject = new Comment();
            }
            #endregion
            ...
            public List<Commment> GetAllCommentsForAnAnswer(string connectionString, int answerId)
            {
                try
                {
                    List<Comment> commentsList = commentDataLayerObject.GetComments(connectionString, answerId);
        ...
        public class Answer
        {
            Question_Answer.Models.Answer postDataLayerObject;
            ...
            public Answer()
            {
                postDataLayerObject = new Question_Answer.Models.Answer();
            ...
            public List<Answer> GetAnswersForAQuestion(string connectionString, int questionId)
            {
                try
                {
                    List<Question_Answer.Models.Post> postList = postDataLayerObject.GetPosts(connectionString,0,null, questionId);
            ...
            #region Utilities
            public static explicit operator Answer(Question_Answer.Models.Post q)
            {
                Answer p = new Answer();
                p.Id = q.Id;
